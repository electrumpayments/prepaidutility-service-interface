...
public abstract class TokenPurchasesResource {
   ...
   public class RetryPurchaseRequest {
      ...
      public static final int SUCCESS = 202;
      public static final String PATH = TokenPurchasesResource.PATH + "/{" + PathParameters.PURCHASE_ID + "}/retry";
   ...
   public class TrialTokenPurchaseRequest {
      ...
      public static final int SUCCESS = 201;
      public static final String PATH = TokenPurchasesResource.PATH + "/trials/{" + PathParameters.PURCHASE_ID + "}";
    ...
    */
   @POST
   @Path(TrialTokenPurchaseRequest.PATH)
   @Consumes({ "application/json" })
   @Produces({ "application/json" })
