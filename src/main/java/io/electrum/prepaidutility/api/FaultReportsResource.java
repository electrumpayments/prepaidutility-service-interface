...
public abstract class FaultReportsResource {
   ...
   public class CreateFaultReport {
      ...
      public static final String RELATVE_PATH = "/{" + PathParameters.REQUEST_ID + "}";
      public static final String PATH = FaultReportsResource.PATH + RELATVE_PATH;
   ...
   @POST
   @Path(CreateFaultReport.RELATVE_PATH)
